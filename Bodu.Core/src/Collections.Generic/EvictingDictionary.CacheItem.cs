...
namespace Bodu.Collections.Generic
{
	public partial class EvictingDictionary<TKey, TValue>
	{
...
#endif
		{
			...
			/// <summary>
			/// Gets or sets a flag indicating whether the item has been recently accessed. Used by the Second-Chance eviction policy to
			/// determine eligibility for eviction.
			/// </summary>
