...
namespace Bodu.Collections.Generic
{
	public static partial class SequenceGenerator
	{
		...
		/// Thrown if <paramref name="conditionHandler" /> or <paramref name="resultSelector" /> is <c>null</c>.
		/// </exception>
		/// <remarks>
		...
		/// <exception cref="ArgumentNullException">
		/// Thrown if <paramref name="conditionHandler" />, <paramref name="iterateFunction" />, or <paramref name="resultSelector" /> is <c>null</c>.
		/// </exception>
		/// <remarks>
