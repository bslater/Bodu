...
namespace Bodu.Extensions
{
	public static partial class ComparableHelper
	{
		...
		/// <returns>
		/// The larger of the two values. If one value is <c>null</c>, the non-null value is returned. If both values are <c>null</c>,
		...
		/// <returns>
		/// The larger of the two values based on the specified comparer. If one value is <c>null</c>, the non-null value is returned. If
