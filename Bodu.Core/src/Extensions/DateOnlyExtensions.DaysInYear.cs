...
namespace Bodu.Extensions
{
	public static partial class DateOnlyExtensions
	{
		...
		/// </summary>
		/// <param name="dateTime">The <see cref="DateOnly" /> for which to calculate the number of days in its calendar year.</param>
		/// <returns>
		...
		/// </remarks>
		public static int DaysInYear(this DateOnly dateTime)
		...
		/// </summary>
		/// <param name="dateTime">The <see cref="DateOnly" /> whose year is evaluated.</param>
		/// <param name="calendar">
		...
		/// </remarks>
		public static int DaysInYear(this DateOnly dateTime, Calendar calendar)
