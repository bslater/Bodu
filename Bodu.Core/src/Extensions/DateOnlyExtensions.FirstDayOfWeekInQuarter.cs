...
namespace Bodu.Extensions
{
	public static partial class DateOnlyExtensions
	{
		...
		/// <returns>
		/// A <see cref="DateOnly" /> value representing the first occurrence of <paramref name="dayOfWeek" /> in the quarter that includes <paramref name="dateTime" />.
		/// </returns>
		...
		/// <remarks>
		/// <para>
		/// The result is calculated by first determining the start day number of the quarter containing <paramref name="dateTime" /> (as
		/// defined by <paramref name="definition" />), and then finding the first occurrence of <paramref name="dayOfWeek" /> on or after
		/// that day.
		/// </para>
		/// <para>The returned date is guaranteed to fall within the same quarter as <paramref name="dateTime" />.</para>
		/// </remarks>
		public static DateOnly FirstDayOfWeekInQuarter(this DateOnly dateTime, DayOfWeek dayOfWeek, CalendarQuarterDefinition definition)
		{
