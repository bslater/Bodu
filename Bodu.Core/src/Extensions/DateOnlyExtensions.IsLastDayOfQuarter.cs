...
namespace Bodu.Extensions
{
	public static partial class DateOnlyExtensions
	{
		...
		/// </remarks>
		public static bool IsLastDayOfQuarter(this DateOnly dateTime)
		{
			var (year, quarter) = GetQuarterAndYearFromDate(CalendarQuarterDefinition.JanuaryDecember, referenceDate: dateTime);
			return dateTime.DayNumber == ComputeQuarterEndDayNumber(year, quarter, GetQuarterDefinition(CalendarQuarterDefinition.JanuaryDecember));
		}
		...
		/// </remarks>
		public static bool IsLastDayOfQuarter(this DateOnly dateTime, CalendarQuarterDefinition definition)
		{
			...
			return dateTime.DayNumber == ComputeQuarterEndDayNumber(year, quarter, GetQuarterDefinition(definition));
		}
		...
		/// </remarks>
		public static bool IsLastDayOfQuarter(this DateOnly dateTime, IQuarterDefinitionProvider provider)
		{
			ThrowHelper.ThrowIfNull(provider);
			return dateTime.DayNumber == provider.GetEndDate(dateTime).DayNumber;
		}
	}
}