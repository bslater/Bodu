// ---------------------------------------------------------------------------------------------------------------
// <copyright file="DateOnlyExtensions.WeekdayOrdinal.cs" company="PlaceholderCompany">
...
namespace Bodu.Extensions
{
	public static partial class DateOnlyExtensions
	{
		...
		/// </exception>
		public static WeekOfMonthOrdinal WeekdayOrdinal(this DateOnly date)
		{
			int ordinal = (int)((date.DayNumber - DateOnlyExtensions.GetDayNumber(date.Year, date.Month, 1)) / 7);
