// // ---------------------------------------------------------------------------------------------------------------
// // <copyright file="DateTimeExtensions.GetStartMonthFromQuarter.cs" company="PlaceholderCompany">
...
namespace Bodu.Extensions
{
	...
	{
		/// <summary>
		/// Returns the 1-based starting month of the specified quarter, based on the given <see cref="CalendarQuarterDefinition" />.
		/// </summary>
		...
		/// <see cref="CalendarQuarterDefinition.Custom" />. Use an external provider to support custom definitions. Also thrown if
		...
		/// <paramref name="definition" />. For example, in a July-based financial year ( <see cref="CalendarQuarterDefinition.FinancialJuly" />),
		/// Q1 starts in July (month 7), Q2 in October (month 10), etc.
		/// </remarks>
		public static int GetStartMonthFromQuarter(CalendarQuarterDefinition definition, int quarter)
		{
