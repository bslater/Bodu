...
namespace Bodu.Extensions
{
	...
	{
		/// <summary>
		/// Rotates the bits of the specified 8-bit unsigned ( <see cref="byte" />) value to the left by the specified <paramref name="count" />.
		/// </summary>
		...
		/// <returns>A <see cref="byte" /> with its bits rotated to the left by <paramref name="count" /> positions.</returns>
		...
		/// <summary>
		/// Rotates the bits of the specified 16-bit unsigned ( <see cref="ushort" />) value to the left by the specified <paramref name="count" />.
		/// </summary>
		...
		/// <returns>A <see cref="ushort" /> with its bits rotated to the left by <paramref name="count" /> positions.</returns>
		/// <exception cref="ArgumentOutOfRangeException">
		...
		/// <summary>
		/// Rotates the bits of the specified 32-bit unsigned ( <see cref="uint" />) value to the left by the specified <paramref name="count" />.
		/// </summary>
		...
		/// <returns>A <see cref="uint" /> with its bits rotated to the left by <paramref name="count" /> positions.</returns>
		/// <exception cref="ArgumentOutOfRangeException">
		...
		/// <summary>
		/// Rotates the bits of the specified 64-bit unsigned ( <see cref="ulong" />) value to the left by the specified <paramref name="count" />.
		/// </summary>
		...
		/// <returns>A <see cref="ulong" /> with its bits rotated to the left by <paramref name="count" /> positions.</returns>
		/// <exception cref="ArgumentOutOfRangeException">
