...
namespace Bodu.Security.Cryptography
{
	...
	/// 64-bit hash code, created by Jean-Philippe Aumasson and Daniel J. Bernstein. This class cannot be inherited.
	/// </summary>
	/// <remarks>
	/// <para>
	...
	/// finalization rounds to generates a 64-bit hash code.
	/// </para>
	/// <para>
