...
{
	/// <summary>
	/// Computes a hash using the Tiger algorithm, a high-performance 64-bit-oriented cryptographic hash function.
	/// </summary>
	/// <remarks>
	/// <para>
	/// Tiger is designed for fast hashing on 64-bit platforms and supports output sizes of 128, 160, or 192 bits. It uses three 64-bit
	/// state variables and three rounds of transformations (each with eight mixing steps).
	/// </para>
	/// <para>This implementation supports multiple output sizes for compatibility with Tiger/128, Tiger/160, and Tiger/192 variants.</para>
