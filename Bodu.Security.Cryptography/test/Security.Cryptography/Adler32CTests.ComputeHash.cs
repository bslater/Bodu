...
namespace Bodu.Security.Cryptography
{
	public partial class Adler32CTests
	{
		...
		/// <summary> Verifies that <see cref="Adler"> produces expected hash for an empty byte array. </summary>
		[DataTestMethod]
		...
		/// <summary> Verifies <see cref="Adler"> hash for simple ASCII text. </summary>
		[DataTestMethod]
		[DynamicData(nameof(GetTestVariants), DynamicDataSourceType.Method)]
		...
		/// <summary> Verifies <see cref="Adler"> hash for byte sequence 0-255. </summary>
		[DataTestMethod]
		[DynamicData(nameof(GetTestVariants), DynamicDataSourceType.Method)]
		...
		/// <summary> Verifies that hashing progressively longer prefixes using the <see cref="Adler"> hash produces expected results using. </summary>
		[DataTestMethod]
		[DynamicData(nameof(GetTestVariants), DynamicDataSourceType.Method)]
